...
AppPorts 内置日志系统，记录应用运行期间的关键事件、迁移操作、系统信息和错误详情。当遇到问题时，可导出诊断包并提交至项目 [Issues](https://github.com/wzh4869/AppPorts/issues) 以协助排查。
...
数据目录操作（迁移、恢复、规范化、重新链接）的日志中自动包含关联应用的上下文信息：
